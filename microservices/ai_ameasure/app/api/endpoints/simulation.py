...
def generate_simulation_data(
    ...
    for i in range(max_record):
        ...
        for position_id in position_ids:
            ...
            simulation_data.append(schemas.SimulationDataPoint(
                td_no=100 + i,
                date=current_date,
...
async def simulate_displacement(
...
async def get_chart_data(
    request: schemas.ChartDataRequest
